...
import type {
  ...
  UserApiKeyMetadata,
  UserApiKeyMintRequest,
  UserApiKeyMintResponse,
  UserApiKeyRevokeRequest,
  UserApiKeyRevokeResponse,
...
export const cliHttpV1Validators = {
  ...
  UserApiKeyListRequest: isUserApiKeyListRequest satisfies (
    value: unknown,
  ) => value is UserApiKeyListRequest,
  UserApiKeyListResponse: isUserApiKeyListResponse satisfies (
    value: unknown,
  ) => value is UserApiKeyListResponse,
  UserApiKeyMetadata: isUserApiKeyMetadata satisfies (
    value: unknown,
  ) => value is UserApiKeyMetadata,
  UserApiKeyMintRequest: isUserApiKeyMintRequest satisfies (
    value: unknown,
  ) => value is UserApiKeyMintRequest,
  UserApiKeyMintResponse: isUserApiKeyMintResponse satisfies (
    value: unknown,
  ) => value is UserApiKeyMintResponse,
  UserApiKeyRevokeRequest: isUserApiKeyRevokeRequest satisfies (
    value: unknown,
  ) => value is UserApiKeyRevokeRequest,
  UserApiKeyRevokeResponse: isUserApiKeyRevokeResponse satisfies (
    value: unknown,
  ) => value is UserApiKeyRevokeResponse,
